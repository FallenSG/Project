...
import { Close, Settings, FormatListNumbered } from '@mui/icons-material';
import { Parser } from 'html-to-react';
import WebFont from 'webfontloader'

import { PageLayout, Context, PageLayoutOverload } from "../Components/PageLayout";
            ...
            <Grid item xs={12} sm={10} md={8} sx={{ border: "#726b57 ridge", borderWidth: "0 1px" }}>
                <Typography variant="body1" 
                    sx={{ 
                        ...
                        p: "5%", 
                        backgroundColor: `${themeSelection[readStyle.theme][0]}`, 
                        color: `${themeSelection[readStyle.theme][2]}`
                    }}>
                    {text}
                </Typography>
            </Grid>
