import { ImageList, ImageListItem, ImageListItemBar, Typography, Box, CircularProgress, Link, Grid, styled } from '@mui/material'
                ...
                {bookCatg.map((book) => (
                    <ImageListItem key={book._id}>
                        <img
                            ...
                            alt='Not Found'
                            loading="lazy"
                            onClick={ event => window.location.href=`/book/${book._id}` }
                        />
                            <ImageListItemBar
                                sx={{ width: '10vw' }}
                                title={book.title}
